...
# бронницы и балашиха есть ("Бронницы", "Балашиха","Красноармейск", "Краснознаменск", , "Котельники", "Красногорск", "Краснозаводск", "Кубинка", "Куровское (Московская)", "Лобня", "Лыткарино", "Ликино-Дулёво", "Кашира","Клин", "Лосино-Петровский",) 

list_2 = ["Луховицы", "Люберцы", "Можайск", "Мытищи", "Наро-Фоминск",
          "Ногинск", "Орехово-Зуево", "Одинцово", "Озёры", "Подольск", "Протвино", "Пущино",]
